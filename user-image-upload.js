/**
 * Created by huaijinwoyu-eo on 2016/12/27.
 */
(function () {
    function UploadComponent() {
        this.createComponent = function (container,containerWidth,URL) {
            //获取包含层的宽度
            var wrapWidth = containerWidth;
    ...
    var ImageUpload = new UploadComponent();
